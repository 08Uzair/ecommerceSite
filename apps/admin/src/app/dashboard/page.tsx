...
import RecentOrders from "../components/order";
  ...
  return (
    <div className="bg-[#e7e7e3] min-h-screen p-6">
      ...
      <div className="flex justify-between items-center p-4 ">
        {/* Left Section */}
        <div className="gap-1">
          <h1 className="text-[24px] font-semibold text-black">Dashboard</h1>
          <p className="text-[16px] text-black">Home &gt; Dashboard</p>
        </div>
